...
export default function Welcome() {
    return (
        ...
        <Typography variant="h6" sx={{ textAlign: 'justify', mb: 2 }}>
            When everything is ready, generate SBOL3.1 files and convert them to formats like FASTA or GenBank. Make your projects easier and more accurate with GC-AI!
        </Typography>
        <Box sx={{ mb:2 }}>
